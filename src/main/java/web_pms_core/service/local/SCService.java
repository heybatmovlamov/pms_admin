...
import web_pms_core.exception.BadRequestException;
import web_pms_core.exception.DataNotFoundException;
import web_pms_core.model.local.request.ScPayRequest;
import web_pms_core.model.local.response.ScResponse;
...
public class SCService {
    ...
    private static ScPayRequest parsePayRequest(String json) {
        ...
        try {
            web_pms_core.config.JSON parser = new web_pms_core.config.JSON(json);
            web_pms_core.config.JSON.Object obj = (web_pms_core.config.JSON.Object) parser.parseObject();
